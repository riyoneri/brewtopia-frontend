...
export default function Register() {
  ...
  const { isPending, mutate, error, data } = useRegister<InputsType>();
  ...
  useEffect(() => {
    ...
    window && setRedirectUrl(`${window.location.origin}/auth/verify`);
    ...
    <>
      ...
      >
        <div className="space-y-2">
          ...
          <p>Create an account to enjoy more in the app</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button
            disabled={isPending}
            type="submit"
            className="mt-3 flex justify-center text-base"
          >
            {isPending ? (
