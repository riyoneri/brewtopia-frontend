      ...
      <Controller
        ...
        render={({ field }) => (
          <DateRangePicker
            ...
            classNames={{
              inputWrapper:
                "border-2 hover:border-neutral-400 focus-within:!border-neutral-400 data-[focus]:border-neutral-400 data-[active]:border-neutral-400 border-neutral-400 h-full px-2 py-1 min-h-max",
              base: "p-0",
              segment:
